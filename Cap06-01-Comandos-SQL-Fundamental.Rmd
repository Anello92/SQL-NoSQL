...
# Um banco de dados relacional é um conjunto de arquivos físicos que armazenam os dados em formato estruturado, organizados em tabelas, que por sua vez são divididas em linhas e colunas. A criação de um banco de dados relacional é baseada na MODELAGEM RELACIONAL. 

# Usamos linguagem SQL para manipular os dados em um banco de dados relacional para manipular os dados. Concentrar em aprender a linguagem SQL em si. 

# A linguagem R suporta diversos bancos de dados relacionais através de PACOTES específicos para cada banco de dados. 

# Usamos um SGBD|RDBMS (sistema gerenciador de bancos de dados) para gerenciar os arquivos do banco de dados. Na prática os bancos de dados são muito parecidos, o que vai mudar é o SGBD da forma que cada banco é gerenciado por seus DBAs. 

# Temos uma tabela para cada tipo de informação diferente, em algum momentos queremos relacionar informações entre tabelas diferentes

#db-engines.com - ranking dos principais bancos de dados do mercado 
#armazenagem de dados para aplicações em geral são/ em mySQL

--------------------------------------------------------------------------------------------------------------------------------------

# Linguagem SQL é uma linguagem de cosulta a bancos de dados - não é uma linguagem de programação. Permite que os usuários acessem dados em sistemas de gerenciamento de bancos de dados relacionais. 

# Permite a manipualação de dados armazenados em bancos de dados, a criação e remoção de objetos no banco de dados (tabelas, índices, visões, procedimentos armazenados), definir privilégios e restrições de acesso a dados sensíveis. 

# Trabalhamos diretamente com os dados armazenados no banco de dados, interagindo através de um sistema SGBD. O sistema SGBD processa a query do usuário e retorna os dados solicitados. 
...
# Oraacle utiliza PL/SQL
# MS Access utiliza o JET SQL
# MS SQL Server utiliza T-SQL
